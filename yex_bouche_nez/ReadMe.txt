========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet yex_bouche_nez
========================================================================

AppWizard a créé cette application yex_bouche_nez pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application yex_bouche_nez.


yex_bouche_nez.vcxproj
...
yex_bouche_nez.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé yex_bouche_nez.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
